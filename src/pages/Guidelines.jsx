    ...
    <>
      ...
      <section className="section" style={{ paddingTop: 0 }}>
        <div className="wrap prose">
          <p className="callout">
            Draft. Still being written and will change before anyone is let in.
          </p>
          ...
          <p>
            You can say you are in danger. You cannot describe how. This is not
            squeamishness. Specific detail is the part that measurably raises
            risk for other people reading, which is why every published
          ...
          <p>
            Unsolicited advice is the fastest way to make someone feel unheard.
            Start with &ldquo;that sounds unbearable.&rdquo; Ask before
          ...
          <p>
            ...
            including the funny ones. Pseudonyms are the default and nobody has
            to explain why.
          </p>
